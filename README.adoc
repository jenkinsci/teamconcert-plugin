...
=== 2.2.1 March 30, 2021
* Compatibility update for Jenkins' table to div migration.  https://jazz.net/jazz/resource/itemName/com.ibm.team.workitem.WorkItem/524132[524132:Adopt - tables to divs migration for Team Concert Plugin]
