...
=== Accessing RTC Build Definition properties in a Pipeline job before checkout step
...
=== Accessing RTC Environment Properties in a Pipeline Job after checkout step
Prop
