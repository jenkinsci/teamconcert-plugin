...
/**
 * 
 * The {@link RtcExtensionProvider} extension point that allows extensions to dynamically provide 
 * load rules for the components in the workspace(s). The extensions are called before the workspace(s)
 * are loaded in the build.
 * 
 * Setting the build property "com.ibm.team.build.useExtension" to true makes  
 * Team Concert plugin load the extensions.
 *
 */
